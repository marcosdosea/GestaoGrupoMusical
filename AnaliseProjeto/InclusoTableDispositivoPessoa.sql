...
INSERT INTO `__efmigrationshistory` VALUES ('20250808032613_InitialCreate','8.0.6'),('20250808033357_PromoverUsuarioParaAdm','8.0.6'),('20250808035321_AtualizarPapelGrupoNaPessoa','8.0.6'),('20260604170502_AdicionaTabelaDispositivoPessoa','8.0.6');
...
INSERT INTO `apresentacaotipoinstrumento` VALUES (1,3,5,0,1),(2,1,4,0,0),(2,2,0,0,0),(2,4,0,0,0),(11,1,10,1,1);
...
--
-- Table structure for table `dispositivopessoa`
--

DROP TABLE IF EXISTS `dispositivopessoa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dispositivopessoa` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idPessoa` int NOT NULL,
  `fcmToken` text NOT NULL,
  `dataAtualizacao` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_DispositivoPessoa_Pessoa_idx` (`idPessoa`),
  CONSTRAINT `fk_DispositivoPessoa_Pessoa` FOREIGN KEY (`idPessoa`) REFERENCES `pessoa` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dispositivopessoa`
--

LOCK TABLES `dispositivopessoa` WRITE;
/*!40000 ALTER TABLE `dispositivopessoa` DISABLE KEYS */;
INSERT INTO `dispositivopessoa` VALUES (1,2,'cwdv9ZCyRU6YoO7uoSwM4m:APA91bEsezDg_t-a65xzihc-uKjObKM2IaBy3aGiixAtMOjeiLjr9DjMIKwAZpNQV5PuRy5JIrEFDaqTw12dY3_VQgZAgxh9KctPGD7Nsj3IT7LVqVnHr50','2026-06-26 15:56:46'),(2,3,'cwdv9ZCyRU6YoO7uoSwM4m:APA91bEsezDg_t-a65xzihc-uKjObKM2IaBy3aGiixAtMOjeiLjr9DjMIKwAZpNQV5PuRy5JIrEFDaqTw12dY3_VQgZAgxh9KctPGD7Nsj3IT7LVqVnHr50','2026-06-26 16:53:39');
/*!40000 ALTER TABLE `dispositivopessoa` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ensaio` VALUES (1,1,'FIXO','2024-08-10 00:00:00','2024-08-11 00:00:00',1,'Local A','Repertório A',2),(2,1,'FIXO','2024-08-29 20:59:00','2024-08-30 20:59:00',1,'Local B','Repertório B',2),(3,1,'FIXO','2024-09-13 16:10:00','2024-09-24 16:10:00',1,'Local C','Rep C',2),(4,1,'FIXO','2024-09-13 16:12:00','2024-09-13 22:18:00',1,'Local D','Rep D',2),(5,1,'FIXO','2026-06-27 16:37:00','2026-07-11 16:37:00',1,'Praça de eventos','Luiz Gonzaga',2),(6,1,'FIXO','2026-06-27 17:02:00','2026-07-10 17:02:00',1,'Praça de eventos','pagode gospel',2),(7,1,'FIXO','2026-06-27 19:56:00','2026-07-10 19:56:00',1,'Praça de eventos','lamod',2);
...
INSERT INTO `ensaiopessoa` VALUES (3,1,0,NULL,0,5),(3,3,0,NULL,0,5),(3,4,0,NULL,0,5),(3,6,0,NULL,0,5),(3,7,0,NULL,0,5),(4,2,0,NULL,0,5),(4,5,0,NULL,0,5),(5,1,0,'Estou doente',0,1),(5,3,0,NULL,0,1),(5,4,0,NULL,0,1),(5,5,0,NULL,0,1),(5,6,0,NULL,0,1),(5,7,0,NULL,0,1),(6,3,0,NULL,0,1),(6,4,0,NULL,0,1),(6,5,0,NULL,0,1),(6,6,0,NULL,0,1),(6,7,0,NULL,0,1),(7,3,0,NULL,0,1),(7,4,0,NULL,0,1),(7,5,0,NULL,0,1),(7,6,0,NULL,0,1),(7,7,0,NULL,0,1),(8,3,0,NULL,0,1),(8,4,0,NULL,0,1),(8,5,0,NULL,0,1),(8,6,0,NULL,0,1),(8,7,0,NULL,0,1);
...
INSERT INTO `evento` VALUES (1,1,'2024-08-22 20:45:00','2024-08-23 20:45:00','Shopping Socorro','Repertório 1',2),(2,1,'2024-08-24 20:45:00','2024-08-27 20:45:00','Shopping Rio Mar','Repertório 2',2),(10,1,'2026-07-24 11:59:00','2026-07-31 11:59:00','teste','axe',2),(11,1,'2026-07-24 12:03:00','2026-07-31 12:03:00','local','123',2);
...
CREATE TABLE `eventopessoa` (
  ...
  `idPessoa` int NOT NULL,
  `idTipoInstrumento` int DEFAULT NULL,
  `presente` tinyint NOT NULL DEFAULT '0',
...
INSERT INTO `eventopessoa` VALUES (1,3,0,0,NULL,0,'INSCRITO',5),(1,4,0,0,NULL,0,'INSCRITO',5),(1,5,3,0,NULL,0,'INSCRITO',1),(2,3,0,0,NULL,0,'INSCRITO',5),(10,3,NULL,0,NULL,0,'INSCRITO',5),(10,4,NULL,0,NULL,0,'INSCRITO',5),(11,3,NULL,0,NULL,0,'INSCRITO',5),(11,4,NULL,0,NULL,0,'INSCRITO',5),(11,5,1,0,NULL,0,'DEFERIDO',1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validar_instrumento_eventopessoa_insert` BEFORE INSERT ON `eventopessoa` FOR EACH ROW BEGIN
    IF NEW.idPapelGrupoPapelGrupo = 1
       AND NEW.idTipoInstrumento IS NULL THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT =
            'Associado precisa de instrumento para participar do evento';
    END IF;
END */;;
DELIMITER ;
...
INSERT INTO `figurino` VALUES (1,'Sao joão 2020','2024-08-21',1),(2,'Maria Jiquinha 1999','1999-10-10',1),(3,'Arrastão','2000-10-10',1),(4,'Thriller','2026-06-04',1);
...
INSERT INTO `figurinoapresentacao` VALUES (2,1),(3,2),(1,10),(1,11);
...
INSERT INTO `figurinoensaio` VALUES (3,1),(1,2),(4,3),(3,4),(1,5),(1,6),(1,7);
...
INSERT INTO `informativo` VALUES (1,1,2,'Informativo','2024-08-26 21:30:05',1),(3,1,2,'Teste de push','2026-06-26 16:54:21',1);
...
INSERT INTO `receitafinanceira` VALUES (1,'Paguem 1','2024-05-10','2024-06-10',20.00,1),(2,'Paguem 2','2024-06-10','2025-07-10',15.00,1),(3,'Paguem 3','2024-07-10','2024-08-28',20.00,1),(10,'Paguem 4','2024-09-09','2024-09-24',50.00,1),(13,'teste','2026-07-23','2026-07-31',100.00,1),(14,'teste atualizado','2026-07-23','2026-07-24',200.00,1);
...
CREATE TABLE `receitafinanceirapessoa` (
  ...
  `status` enum('ABERTO','ENVIADO','PAGO','ISENTO','NAO_PAGOU','PAGO_COMPROVANTE') NOT NULL DEFAULT 'NAO_PAGOU',
...
INSERT INTO `receitafinanceirapessoa` VALUES (1,5,20.00,20.00,'2024-05-10 00:00:00','NENHUMA 1','PAGO'),(2,5,15.00,0.00,'2024-05-10 00:00:00','NENHUMA 2','ABERTO'),(3,5,20.00,0.00,'2024-05-10 00:00:00','NENHUMA 3','ISENTO'),(10,5,50.00,0.00,'2024-09-09 17:12:18',NULL,'ABERTO'),(13,5,100.00,0.00,'2026-07-24 00:00:00','pagou em moedas','PAGO'),(13,6,100.00,0.00,NULL,NULL,'ABERTO'),(13,7,100.00,0.00,NULL,NULL,'ABERTO'),(13,8,100.00,0.00,NULL,NULL,'ABERTO'),(14,5,200.00,0.00,NULL,NULL,'NAO_PAGOU'),(14,6,200.00,0.00,NULL,NULL,'NAO_PAGOU'),(14,7,200.00,0.00,NULL,NULL,'NAO_PAGOU'),(14,8,200.00,0.00,NULL,NULL,'NAO_PAGOU');
...
--
-- Dumping events for database 'grupomusical'
--
...
-- Dump completed on 2026-07-23 12:57:01
