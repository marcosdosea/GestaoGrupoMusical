...
class PagamentosSolicitadosView extends StatefulWidget {
  const PagamentosSolicitadosView({super.key});

  @override
  State<PagamentosSolicitadosView> createState() => _PagamentosSolicitadosViewState();
}

class _PagamentosSolicitadosViewState extends State<PagamentosSolicitadosView> {
  final FinanceiroService service = FinanceiroService();
  late Future<List<FinanceiroModel>> _futurePagamentos;
  ...
  void _carregarDados() {
    _futurePagamentos = service.getAll();
  }
          ...
          if (snapshot.hasError) {
            return RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  SliverFillRemaining(
                    child: Center(child: Text("Erro ao carregar pagamentos: ${snapshot.error}")),
                  ),
                ],
              ),
            );
          ...
          if (lista.isEmpty) {
            return RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  SliverFillRemaining(
                    child: Center(child: const Text("Nenhum pagamento pendente no momento.")),
                  ),
                ],
              ),
            );
